        ...
        confirmAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(name)){
                    ...
                    Toast.makeText(AddActivity.this, "Please fill all the details correctly before confirming", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddActivity.this, "Please choose a product image", Toast.LENGTH_SHORT).show();
                }else{
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            //product list will be same for every user but in cart user add diff product according to user
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull @NotNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                Toast.makeText(AddActivity.this, "Product added successfully after verification", Toast.LENGTH_LONG).show();
                                                Intent intent= new Intent(AddActivity.this, HomeActivity.class);
                                                startActivity(intent);
                                                finish();
                                            }
