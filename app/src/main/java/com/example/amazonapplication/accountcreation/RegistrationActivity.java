package com.example.amazonapplication.accountcreation;
...
import com.example.amazonapplication.View.HomeActivity;
import com.example.amazonapplication.modeldata.Users;
                    ...
                    auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                imgUri="https://firebasestorage.googleapis.com/v0/b/applicationclone-e91a7.appspot.com/o/profilepic.png?alt=media&token=dde8245a-fcf7-4bbf-96fc-714a10ddff73";
